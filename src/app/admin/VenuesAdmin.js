...
// Mappa (client-only) delle bevute su tutti i locali, come quella del profilo.
...
export default function VenuesAdmin() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {/* MAPPA GENERALE delle bevute (tutti i locali), stile heatmap del profilo */}
      {(() => {
        ...
        return (
          <div className="card" style={{ padding: 16 }}>
            <h3 style={{ fontSize: 15, fontWeight: 800, display: 'flex', alignItems: 'center', gap: 8, margin: '0 0 10px' }}>
              <MapPin size={17} color="var(--primary)" /> Mappa delle bevute
            </h3>
            {points.length > 0 ? (
              <>
                <RouteMap waypoints={points} height="420px" connectLine={false} />
