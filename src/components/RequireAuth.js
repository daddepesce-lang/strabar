...
export default function RequireAuth({ feature = 'questa sezione' }) {
  return (
    <div style={{ maxWidth: '480px', margin: '0 auto', textAlign: 'center' }}>
      <div className="card" style={{ border: '1px solid var(--primary)', background: 'linear-gradient(135deg, rgba(22,24,34,1) 0%, rgba(255,94,0,0.08) 100%)', padding: '40px 28px' }}>
        <div style={{ display: 'inline-flex', position: 'relative', background: 'rgba(255,94,0,0.12)', padding: '18px', borderRadius: '20px', color: 'var(--primary)', marginBottom: '16px' }}>
