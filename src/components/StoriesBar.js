          ...
          >
            <span
              style={{
                ...
                background: s.live
                  ? 'conic-gradient(from 0deg, #FF2000, #FF8A00, #FF2000)'
            ...
            >
              ...
              />
              {s.live && (
                <span style={{ position: 'absolute', bottom: '-2px', left: '50%', transform: 'translateX(-50%)', background: '#FF2000', color: '#fff', fontSize: '8px', fontWeight: 800, padding: '1px 6px', borderRadius: '8px', letterSpacing: '.3px', border: '1.5px solid var(--bg-dark, #0B0A09)' }}>
                  LIVE
                </span>
              )}
              {!s.live && s.drinks > 0 && (
                <span style={{ position: 'absolute', bottom: '-3px', right: '-2px', background: 'var(--secondary)', color: '#0D0D0D', fontSize: '10px', fontWeight: 800, minWidth: '18px', height: '18px', borderRadius: '9px', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 4px', border: '1.5px solid var(--bg-dark, #0B0A09)' }}>
                  🍺{s.drinks}
                </span>
              )}
            </span>
