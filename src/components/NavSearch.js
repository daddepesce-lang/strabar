        ...
        <div className="notif-dropdown" style={{ padding: '12px' }}>
          ...
          {query.trim().length >= 1 && (
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <button
                onClick={goToFull}
                style={{ marginTop: '6px', padding: '8px', borderRadius: '8px', background: 'rgba(255,94,0,0.08)', border: '1px solid var(--border-dark)', color: 'var(--primary)', fontWeight: 700, fontSize: '13px', cursor: 'pointer' }}
              >
