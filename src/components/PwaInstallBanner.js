    ...
    <>
      <div
        style={{
          ...
          borderRadius: '14px',
          boxShadow: '0 8px 30px rgba(0,0,0,0.5), 0 0 18px rgba(255,94,0,0.25)',
          padding: '12px 14px',
          display: 'flex',
          alignItems: 'center',
          gap: '12px',
      ...
      >
        <div style={{ background: 'rgba(255,94,0,0.12)', color: 'var(--primary)', width: 42, height: 42, borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
